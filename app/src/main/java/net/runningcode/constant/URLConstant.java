...
public class URLConstant {
    ...
    public static final String API_GET_WEATHER = "http://t.weather.sojson.com/api/weather/city/";
    public static final String API_GET_IP_INFO = "http://apis.baidu.com/apistore/iplookupservice/iplookup";
    public static final String API_GET_PHONE_INFO = "http://apis.juhe.cn/mobile/get?key=e384bfb3fe5e8061940eecea3ca7ee4e";
    public static final String API_GET_LOTTERY_INFO = "http://apis.juhe.cn/lottery/query?key=7149f21dc5e321811465c8899d0013e3";
    public static final String API_GET_ID_INFO = "http://apis.juhe.cn/idcard/index?key=b580571f39a135f65df89997861bb136";
    ...
    public static final String API_GET_TANSLATE_INFO = "http://fanyi.youdao.com/openapi" +
            ".do?keyfrom=FastQuery2&key=760605702&type=data&doctype=json&version=1.1";
    ...
    public static Integer getWhat(String url) {
