...
public class SalaryActivity extends BasicActivity {
    ...
    private void compute(int salary) {
        ...
        double syRate = SalaryUtil.getSYRate("beijing");
        ...
        mVYljSelf.setText(String.valueOf(ylj));
        mVYlSelf.setText(String.valueOf(ylbx));
        mVSySelf.setText(String.valueOf(sy));
        mVGrsds.setText(String.valueOf(sds));
        mVTotalPayOut.setText(String.valueOf(bxf + sds));
    }
